...
namespace Common
{
    ...
    {
        double xmin = BIG_POS_NUM;
        double ymin = BIG_POS_NUM;
        double zmin = BIG_POS_NUM;

        double xmax = BIG_NEG_NUM;
        double ymax = BIG_NEG_NUM;
        double zmax = BIG_NEG_NUM;
    ...
    double RegularHexahedron::volume_of_overlap(const RegularHexahedron& b)
    {
        double ov = 0.;
    ...
    bool RegularHexahedron::do_contain(const RegularHexahedron& other) const
    {
        for (int i=0; i<NDIM; ++i)
        {
